...
/*
	...
	access: r/o (partial) authenticated users, r/w admins
...
class page_output
{
	...
	function execute()
	{
		...
		*/
		...
		$input_fields_disable = user_permissions_get("admin") ? "no" : "yes";
...
/*
		...
		$structure["options"]["disabled"]		= $input_fields_disable;
